...
import com.example.newsapp.item.TechnologyItem;
...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.TechnologyViewHolder> {
    ...
    public TechnologyAdapter(Context context, ArrayList<TechnologyItem> technologyList) {
    ...
    public TechnologyAdapter.TechnologyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.technology_item,parent, false);
        final TechnologyViewHolder viewHolder = new TechnologyViewHolder(view);
        ...
        viewHolder.item_news.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String id = technologyList.get(viewHolder.getAdapterPosition()).getId();
     ...
     * Init news dialog
     */
    private void initDialog(final TechnologyViewHolder viewHolder) {
        ...
        dialog_home_title.setText(technologyList.get(viewHolder.getAdapterPosition()).getTitle());
        String imgUrl = technologyList.get(viewHolder.getAdapterPosition()).getImgUrl();
         ...
         */
        final String webUrl = technologyList.get(viewHolder.getAdapterPosition()).getWebUrl();
         ...
         */
        final String title = technologyList.get(viewHolder.getAdapterPosition()).getTitle();
...
//                dialog_bookmark.setImageResource(R.drawable.filled_bookmark);
    ...
    @Override
    public void onBindViewHolder(@NonNull final TechnologyAdapter.TechnologyViewHolder holder, int position) {

        // Log.d("aaa","Position————"+position);
        TechnologyItem cur_item = technologyList.get(position);
    ...
    public class TechnologyViewHolder extends RecyclerView.ViewHolder{
        ...
        public TechnologyViewHolder(@NonNull View itemView) {
            super(itemView);
            item_news = itemView.findViewById(R.id.technology_news_item);
