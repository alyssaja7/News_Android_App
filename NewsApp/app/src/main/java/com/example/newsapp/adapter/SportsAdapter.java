...
import com.example.newsapp.item.SportsItem;
...
public class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.SportsViewHolder> {
    ...
    private ArrayList<SportsItem> sportsList;

    boolean bookmark_filled = false;

    Dialog newsDialog;
    public SportsAdapter(Context context, ArrayList<SportsItem> sportsList) {
    ...
    public SportsAdapter.SportsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.sports_item,parent, false);
        final SportsViewHolder viewHolder = new SportsViewHolder(view);
        ...
        viewHolder.item_news.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String id = sportsList.get(viewHolder.getAdapterPosition()).getId();
     ...
     * Init news dialog
     */
    private void initDialog(final SportsViewHolder viewHolder) {
        ...
        dialog_home_title.setText(sportsList.get(viewHolder.getAdapterPosition()).getTitle());
        String imgUrl = sportsList.get(viewHolder.getAdapterPosition()).getImgUrl();
         ...
         */
        final String webUrl = sportsList.get(viewHolder.getAdapterPosition()).getWebUrl();
         ...
         */
        final String title = sportsList.get(viewHolder.getAdapterPosition()).getTitle();
...
//                dialog_bookmark.setImageResource(R.drawable.filled_bookmark);
    ...
    @Override
    public void onBindViewHolder(@NonNull final SportsAdapter.SportsViewHolder holder, int position) {
        // Log.d("aaa","Position————"+position);
        SportsItem cur_item = sportsList.get(position);
    ...
    public class SportsViewHolder extends RecyclerView.ViewHolder {
        ...
        public SportsViewHolder(@NonNull View itemView) {
            super(itemView);
            item_news = itemView.findViewById(R.id.sports_news_item);
