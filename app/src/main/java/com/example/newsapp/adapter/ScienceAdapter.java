...
public class ScienceAdapter extends RecyclerView.Adapter<ScienceAdapter.ScienceViewHolder> {
    ...
    public ScienceAdapter(Context context, ArrayList<ScienceItem> scienceList) {
    ...
    @NonNull
    @Override
    public ScienceAdapter.ScienceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.science_item,parent, false);
        final ScienceViewHolder viewHolder = new ScienceViewHolder(view);
        ...
        viewHolder.item_news.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                id = scienceList.get(viewHolder.getAdapterPosition()).getID();
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void initDialog(final ScienceViewHolder viewHolder) {
        ...
        //set text or img
        final String title = scienceList.get(viewHolder.getAdapterPosition()).getTitle();
        dialog_home_title.setText(title);

        String imgUrl = scienceList.get(viewHolder.getAdapterPosition()).getImgUrl();
         ...
         */
        final String webUrl = scienceList.get(viewHolder.getAdapterPosition()).getWebUrl();
...
//        if(bookmark_filled){
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(@NonNull final ScienceAdapter.ScienceViewHolder holder, int position) {

        ScienceItem cur_item = scienceList.get(position);
    ...
    private String diffTime(String time) {
        ...
        Log.e("Science localT", localTime.toString());
        Log.e("Science publishT", publishTime.toString());
        Log.e("Science diff", diff);
        return diff;
    }
    ...
    @Override
    public int getItemCount() { return scienceList.size(); }
    ...
    public class ScienceViewHolder extends RecyclerView.ViewHolder{
        ...
        public ScienceViewHolder(@NonNull View itemView) {
            ...
            item_news = itemView.findViewById(R.id.science_news_item);
